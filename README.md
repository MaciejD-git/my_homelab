...
- **Storage & backup:** Central NAS with ZFS and dedicated backup infrastructure (Proxmox Backup Server for VM/LXC and Veeam for file-level backups from endpoints).  
